...
import {OverlayService, PrimeTemplate, TranslationKeys} from "primeng/api";
import {BaseInput} from "primeng/baseinput";
import {
  type DatePickerMonthChangeEvent,
  type DatePickerResponsiveOptions,
  DatePickerStyle,
  type DatePickerTypeView,
...
import {type Nullable, type VoidListener} from "primeng/ts-helpers";
...
export class JalaliDatepickerComponent extends BaseInput implements OnInit, AfterContentInit, AfterViewInit, OnDestroy {
